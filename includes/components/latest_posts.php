...
<span class="uk-text-left home_title">Recently <i class="fas fa-sync-alt homepage_icon"></i></span>
</div>
...
?>
<div class="uk-padding-small uk-width-1-1@s uk-width-1-4@m uk-width-1-4@l">
 <div class="cat-posts uk-border-rounded uk-inline-clip uk-transition-toggle uk-animation-toggle" style="background-image: url(<?php echo empty($post['Image']) ? 'admin/uploads/posts/user.jpg' : 'admin/uploads/posts/' . $post['Image'];?>)">
   <div class="uk-overlay-primary uk-border-rounded">
     ...
     <div class="uk-card-footer uk-margin-remove uk-padding-remove uk-transition-slide-bottom-small" uk-grid>
